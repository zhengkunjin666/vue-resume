            ...
            <el-row :gutter="100">
                <el-col :lg="12">
                    <div class="grid-content">
                        ...
                        <p>
                            拥有4 年开发经验，精通 HTML、CSS、JavaScript
                            基础，掌握 Vue、Ant Design
                            Vue、Element、微信小程序等前端基础框架技术，熟悉
                            Gulp、Vue CLI3、Vite 等工程化工具，了解 Node.js 和
                            Serverless
                ...
                <el-col :lg="12">
                    <div class="grid-content">
                        ...
                        <ul class="user-power">
                            <li>
                                Web开发：
                                <el-tag size="small" type="danger">HTML</el-tag>
                                <el-tag size="small" type="danger">CSS</el-tag>
                            ...
                            <li>
                                ...
                                <el-tag size="small" type="danger">Vite</el-tag>
                            </li>
                            <li>
                                数据存储：
                    ...
                    >
                        <div class="grid-content">
                            <el-card>
                                ...
                                <p class="card-text">
                                    <span>项目描述：</span
                                    >该项目中主要展示当前流域雨情、水情、工情、险情、灾情及视频监控情况。根据预报环节选择的预报结果，默认推送该预报结果下，流域内河道、堤防超警戒、超堤防设计或者漫堤情况，并在地图上展示。预演展示依据前面环节预报结果情况，大尺度方面展示流域产汇流及演进过程，以及当前水库可利用情况及来水组成并进行水库调度方案的操作。根据推荐调度方案，生成调度建议，并在地图上展示动用水库情况。
                                </p>
                                <p class="card-text">
                                    <span>项目成就：</span>
                                    1、项目中使用Vue3.0 Composition
                                    API、Vite、Pinia、Apache ECharts
                                    可视化图表库、Element
                                    Plus组件库等进行项目的搭建。<br />
                                    2、通过amfe-flexible、postcss-pxtorem插件和在样式文件中设置变量使得样式文件、style和js中的px都能转换为rem，从而实现了页面的自适应。<br />
                                    3、将Element中的弹窗组件封装成可拉伸、可拖拽及放大缩小的新弹窗组件。<br />
                                    4、通过el-slider组件实现了地图上的淹没播放及库区水面线（图表）的播放展示。<br />
                                    5、实现了综合展示、预演、预案等核心业务模块的前端交互。
                                </p>
                            </el-card>
                        </div>
                        <div class="grid-content">
                        ...
                        <div class="grid-content">
                            <el-card>
                                ...
                                <p class="card-text">
                                    ...
                                    2、在重构中沉淀的 Vue3.0、Vite
                                    方案很好的运用在新项目中。<br />
                                    3、在项目中熟练使用 Ant Design Vue
                                    UI组件、Apache ECharts 可视化图表库。<br />
                        ...
                        <div class="grid-content">
                            <el-card>
                                ...
                                <p class="card-text">
                                    ...
                                    Vue2.0 基础上对前台、中台、后台进行 Vue3.0
                                    、Vite、Pinia 的重构和升级。
                                </p>
                                <p class="card-text">
                                    <span>项目成就：</span>
                                    1、项目中使用 Vue3.0 Composition
                                    API、Vite、Pinia 、Element Plus 新一代的 Vue
                                    生态重构项目，替换 Option API、Vue
                                    Cli3、Vuex 等 Vue2.0 组件。<br />
                                    2、通过重构登录项目，掌握 SSO
                                    单点登录相关知识，利用二级域名中的项目可以访问根域的
                                    cookie
                                    实现，实现微信、手机号登录模式的动态切换，掌握微信登录
                                    oauth 相关流程。<br />
                                    3、通过重构主站前台项目，实现视频课、技能测评核心业务模块的前端交互。<br />
                                    4、通过重构学习中台项目，掌握音视频的基本
                                    API
                        ...
                        <div class="grid-content">
                            <el-card>
                                ...
                                <p class="card-text">
                                    ...
                                    高效还原设计稿的能力。<br />
                                    6、独立完成多图轮播，留言板留言拖拽等功能，对
                                    JavaScript DOM 和 BOM 有深入探索。
                                </p>
                            </el-card>
                        </div>
                        <div class="grid-content">
                            <el-card>
                                ...
                                <p class="card-text">
                                    <span>项目成就：</span>
                                    1、使用 Node.js 中 Express 框架快速搭建 Web
                                    框架。<br />
                                    2、在 nunjucks
                                    模版中直接书写HTML结构，通过打包工具 Gulp
                                    处理 CSS
                        ...
                        <div class="grid-content">
                            <el-card>
                                ...
                                <p class="card-text">
                                    ...
                                    2、在第一版本项目中使用 Express、knex
                                    来构建简易的 API，对 Node.js 与 MySQL
                                    数据库更熟悉的运用。<br />
                                    3、在第二版中开始对 Koa
                                    框架进行学习，并对升级到个人 OKR
                                    的开源应用中。<br />
                                    4、在第三版中对通过对微信小程序云开发的学习，对
                                    Serverless
